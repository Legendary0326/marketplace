...
<div class="container mt-4">
    <div class="row py-1" id="subMenu">
        ...
        <div class="col-md-6 px-2" id="" style="display: ">
            <a class="text-white" href="/litecoinwallet" class="btn btn-link"><lang>Litecoin Wallet</lang></a>
        </div>
    </div>
</div>
<?php
            ...
            if (BTC::checkAddress($_POST['Address'])) {
                ...
                if ($UserAmount > 0) {
                    ...
                    if ($USD >= BTC_MINUSD) {
                        ...
                        echo Alerts::danger(sprintf('<lang>The Balance On Your Account Is Too Low! (Min. Balance = %.2f US-$!)</lang>', BTC_MINUSD), 'mt-3');
                    }
                } else {
...
<div class="container mt-3">
    <div class="row py-1">
        <div class="col-md-12 text-info">
            <h3><lang>Your Personal Bitcoin Wallet</lang>...</h3>
        </div>
    </div>
</div>
...
<div class="container mt-3">
    <div class="row py-1">
        <div class="col-md-12">
            ...
            <br><br>
            <span class="text-danger"><lang>If you send Bitcoins to an unvalid address, they might not be credited properly!</lang></span>
        </div>
    </div>
</div>
...
<div class="container mt-3">
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-primary btn-block mx-auto d-block" style="width: 33%; min-width: 250px;" href="/bitcoinwallet/create"><lang>Create Deposit Address</lang></a>
        </div>
    </div>
</div>
