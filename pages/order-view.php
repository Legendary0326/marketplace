...
if (empty($OrderID)) {
    echo Alerts::danger('<lang>No Order Selected!</lang>', 'mt-3');
    return;
}
...
if ($User->hasRole('staff') || $User->hasRole('admin')) {
    ...
    if ($item['Status'] == 'Finalized' && is_null($item['BuyerReview'])) {
        ...
        if (($item['Status'] == 'Shipped' || $item['Status'] == 'Dispute') && $Paths[1] == 'finalize') {
            echo '<div class="row justify-contend-md-center"><div class="col-10 offset-1 col-md-6 offset-md-3 border p-2 mt-5 mb-5"><div class="text-muted text-center"><lang>Are You Sure You Want To Finalize Your Order?</lang><br><lang>After Your Confirmation, the Purchase Price Will Be Irrevocably Credited To the Vendor!</lang></div><div class="mt-3"><a class="btn btn-sm btn-success w-25 float-left ml-3" href="/order-view/' . $item['OrderID'] . '/finalize-do"><lang>YES</lang></a><a class="btn btn-sm btn-danger w-25 float-right mr-3" href="/order-view/' . $item['OrderID'] . '"><lang>NO</lang></a></div></div></div>' . nl;
            return;
        } else if ($item['Status'] == 'Shipped' && $Paths[1] == 'dispute' && $item['Payment'] != 'fe') {
            echo '<div class="row justify-contend-md-center"><div class="col-10 offset-1 col-md-6 offset-md-3 border p-2 mt-5 mb-5"><div class="text-muted text-center"><lang>Are You Sure You Want To Start a Dispute?</lang></div><div class="mt-3"><a class="btn btn-sm btn-success w-25 float-left ml-3" href="/order-view/' . $item['OrderID'] . '/dispute-do"><lang>YES</lang></a><a class="btn btn-sm btn-danger w-25 float-right mr-3" href="/order-view/' . $item['OrderID'] . '"><lang>NO</lang></a></div></div></div>' . nl;
            return;
...
//Order-Nr
echo '<div class="container mt-3"><div class="row py-1"><div class="col-md-12 text-info"><h3><lang>Order-Nr.</lang>:&nbsp;' . Market::OrderID($OrderID) . '</h3></div></div></div>' . nl;
...
if ($item['Status'] == 'Shipped') {
    ...
    if ($TimeLeft <= 0) {
        echo '<lang>Process Pending</lang>';
    } else {
...
if ($DoReview) {
    if ($IamVendor) {
        echo '<div class="container mt-2"><div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-success"><h4><lang>The order is finalized! Please leave a review for the buyer!</lang></h4></span></div></div></div>' . nl;
    } else {
        echo '<div class="container mt-2"><div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-success"><h4><lang>Your order is finalized! Please leave a review for the vendor!</lang></h4></span></div></div></div>' . nl;
    }
}

if ($item['Status'] == 'Dispute' || (!$IamVendor && $item['DisputeRequested'])) {
    echo '<div class="container mt-2"><div class="row py-1"><div class="col-auto col-md-8"><span class="text-danger"><h4><lang>Open dispute!</lang></h4></span></div></div></div>' . nl;
}

echo '<div class="container mt-0"><div class="row py-1">' . nl;

//Item
echo '<div class="col-md-12"><span class="font-weight-light text-muted"><lang>Item</lang>:</span>&nbsp;&nbsp;' . htmlentities($item['Name']) . '</div>' . nl;

//Category
echo '<div class="col-md-12"><span class="font-weight-light text-muted"><lang>Category</lang>:</span>&nbsp;&nbsp;';
...
//Vendor
echo '<div class="col-8 col-md-4"><span class="font-weight-light text-muted"><lang>Vendor</lang>:</span></div><div class="col-auto col-md-8"><a href="/profile/' . $item['Vendor'] . '" class="text-primary"><span class="text-nowrap">' . htmlentities(ucfirst($User->getByUserID('Username', $item['Vendor']))) . '</span></a></div>' . nl;
if ($IamVendor || $User->hasRole('staff') || $User->hasRole('admin')) {
    //Buyer
    echo '<div class="col-8 col-md-4"><span class="font-weight-light text-muted"><lang>Buyer</lang>:</span></div><div class="col-auto col-md-8"><a href="/profile/' . $item['Buyer'] . '" class="text-primary"><span class="text-nowrap">' . htmlentities(ucfirst($User->getByUserID('Username', $item['Buyer']))) . '</span></a></div>' . nl;
}

if (($User->hasRole('staff') || $User->hasRole('admin')) && !is_null($item['Moderator'])) {
    echo '<div class="col-8 col-md-4"><span class="font-weight-light text-muted"><lang>Moderator</lang>:</span></div><div class="col-auto col-md-8"><a href="/profile/' . $item['Moderator'] . '" class="text-primary"><span class="text-nowrap">' . htmlentities(ucfirst($User->getByUserID('Username', $item['Moderator']))) . '</span></a></div>' . nl;
}

//Item-Nr
echo '<div class="col-8 col-md-4"><span class="font-weight-light text-muted"><lang>Item Nr.</lang>:</span></div><div class="col-auto col-md-8"><span class="text-nowrap">' . Market::ItemID($item['Item']) . '</span></div>' . nl;

//Item Class
echo '<div class="col-8 col-md-4"><span class="font-weight-light text-muted"><lang>Item Class</lang>:</span></div><div class="col-auto col-md-8">' . $Language->translate($item['Class']) . '</div>' . nl;

//Payment Processing
echo '<div class="col-8 col-md-4"><span class="font-weight-light text-muted"><lang>Payment Processing</lang>:</span></div><div class="col-auto col-md-8">' . $Language->translate($item['Payment']) . '</div>' . nl;
...
if ($DoReview) {
    ...
    if ($IamVendor) {
        echo '<div class="col-10 col-md-4"><span class="font-weight-light text-muted"><lang>Buyer&rsquo;s Confidentiality</lang>:</span></div><div class="col-auto col-md-8">' . stars('BuyerConfidentiality') . '</div>' . nl;
        echo '<div class="col-10 col-md-4"><span class="font-weight-light text-muted"><lang>Buyer&rsquo;s Communication</lang>:</span></div><div class="col-auto col-md-8">' . stars('BuyerCommunication') . '</div> ' . nl;
    } else {
        echo '<div class="col-10 col-md-4"><span class="font-weight-light text-muted"><lang>Vendor&rsquo;s Service</lang>:</span></div><div class="col-auto col-md-8">' . stars('VendorService') . '</div>' . nl;
        echo '<div class="col-10 col-md-4"><span class="font-weight-light text-muted"><lang>Vendor&rsquo;s Communication</lang>:</span></div><div class="col-auto col-md-8">' . stars('VendorCommunication') . '</div> ' . nl;
        echo '<div class="col-10 col-md-4"><span class="font-weight-light text-muted"><lang>Price Performance Ratio</lang>:</span></div><div class="col-auto col-md-8">' . stars('VendorRatio') . '</div>' . nl;
    }
    echo '</div></div>' . nl;

    //Textarea
    echo '<div class="container mt-3"><div class="row py-1"><div class="col-md-12 font-weight-light text-muted mb-2"><lang>Please Leave a Feedback</lang>...</div><div class="col-md-12"><div class="form-group"><textarea class="form-control" rows="5" name="Feedback"></textarea></div></div></div></div>' . nl;

    //Button
    echo '<div class="container mt-1"><div class="row py-1"><div class="col-md-12"><button type="submit" class="btn btn-primary btn-block"><lang>Submit Review</lang></button></div></div></div>' . nl;
...
//Date
echo '<div class="row py-1"><div class="col-7 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Date</lang>:</span></div><div class="col-auto text-nowrap">' . $Language->date($item['Created']) . '</div></div>' . nl;

//Quantity
echo '<div class="row py-1"><div class="col-7 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Quantity</lang>:</span></div><div class="col-auto">' . $item['Quantity'] . '</div></div>' . nl;

//Single Price
echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Singel Price</lang>:</span></div><div class="col-auto text-nowrap">';
...
//Price Subtotal
echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Price Subtotal</lang>:</span></div><div class="col-auto text-nowrap">';
...
//Shipping Method
echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Shipping Method</lang>:</span></div><div class="col-auto">';
echo (isset($Shippings[$item['Shipping'] . '_' . $item['ShippingType']]) ? htmlentities($Shippings[$item['Shipping'] . '_' . $item['ShippingType']]['Name']) : '');
echo '</div></div>' . nl;

//Shipping Costs
echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Shipping Costs</lang>:</span></div><div class="col-auto text-nowrap">';
...
if ($IamVendor) {
    //Price Total
    echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="text-muted text-nowrap font-weight-bold"><lang>Price Total</lang>:</span></div><div class="col-auto text-nowrap">';
    ...
    //Commission Fee
    echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="text-muted text-nowrap"><lang>Commission Fee</lang></span><span class="text-muted text-nowrap pl-2">(<lang>Currently</lang></span><span class="text-muted"> ' . $FEE . '%)</span></div><div class="col-auto text-nowrap">';
    ...
    //Payout
    echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="text-success text-nowrap font-weight-bold"><lang>Payout</lang>:</span></div><div class="col-auto text-nowrap">';
    ...
    echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted"><lang>Selected Cryptocurrency</lang>:</span></div><div class="col-auto col-md-4 align-text-bottom"><img class="mb-1" src="/img/' . $PayWith . '_color.png" alt="Logo" title="" width="16px" height="16px"/><span class="pl-1" id="color-' . $PayWith . '">';
    if ($item['PayWith'] == 'XMR') {
        echo 'Monero';
    ...
    //Payout
    echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Payout</lang>:</span></div><div class="col-auto text-nowrap"><span class="font-weight-bold" id="color-' . $PayWith . '" style="font-size: 120%;">' . $Language->number($PayoutCrypto, 8) . '</span>&nbsp;&nbsp;<span id="color-' . $PayWith . '">' . $item['PayWith'] . '</span></div></div>' . nl;

    echo '</div>' . nl;

    //Order Status
    echo '<div class="container mt-0"><div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted"><lang>Order Status</lang>:</span></div><div class="col-auto col-md-4">' . Market::getButton($item['Status']) . '</div></div></div>' . nl;
    ...
    //Selected Cryptocurrency
    echo '<div class="row py-1"><div class="col-10 col-md-4"><span class="font-weight-light text-muted"><lang>Selected Cryptocurrency</lang>:</span></div><div class="col-auto align-text-bottom"><img class="mb-1" src="/img/' . $PayWith . '_color.png" alt="Logo" title="" width="16px" height="16px"/><span class="pl-1" id="color-' . $PayWith . '">';
    if ($item['PayWith'] == 'XMR') {
        echo 'Monero';
    } else if ($item['PayWith'] == 'BTC') {
        echo 'Bitcoin';
    ...
    //Payable Amount
    echo '<div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Payable Amount</lang>:</span></div><div class="col-auto text-nowrap"><span class="font-weight-bold" id="color-' . $PayWith . '" style="font-size: 120%;">' . Currencies::exchange($Total, 'USD', $item['PayWith']) . '</span>&nbsp;&nbsp;<span id="color-' . $PayWith . '">' . $item['PayWith'] . '</span></div></div>' . nl;

    echo '</div>' . nl;

    //Order Status
    echo '<div class="container mt-0"><div class="row py-1"><div class="col-8 col-md-4"><span class="font-weight-light text-muted text-nowrap"><lang>Order Status</lang>:</span></div><div class="col-auto col-md-4">' . Market::getButton($item['Status']) . '</div></div></div>' . nl;
...
if ($item['Status'] == 'Dispute' || (!$IamVendor && $item['DisputeRequested'])) {
    ...
    foreach ($Messages as $Message) {
        echo '<div class="container mt-3"><div class="row py-1"><div class="col-md-12 mb-2"><span class="font-weight-light text-muted"><lang>Message from:</lang></span><a href="/profile/' . $Message['User'] . '" class="text-primary pl-2"><span class="text-nowrap">' . htmlentities(ucfirst($Message['Name'])) . '</span></a><span class="font-weight-light text-muted pl-2"><lang>send on:</lang></span><span class="pl-2">' . $Language->date($Message['Created']) . '</span></div><div class="col-md-12"><div class="form-group"><textarea class="form-control overflow-auto" rows="5">' . htmlentities($Message['Message']) . '</textarea></div></div></div></div>' . nl;
    }

    echo '<form action="/order-view/' . $item['OrderID'] . '" method="post">' . nl;

    //Textarea
    echo '<div class="container mt-3"><div class="row py-1"><div class="col-md-12 font-weight-light text-muted mb-2"><lang>Add a new message to the dispute:</lang></div><div class="col-md-12"><div class="form-group"><textarea class="form-control" rows="3" placeholder="<lang>Enter your message</lang>" name="Message"></textarea></div></div></div></div>' . nl;

if (Captcha::showCaptcha()) {
    //Captcha
    echo '<div class="container mt-3"><div class="row py-1"><div class="col-md-12 mb-3 form-group"><img src="' . Captcha::get() . '" alt="" title="Captcha" /></div><div class="col-8 col-md-4 mb-3 form-group"><input type="text" class="form-control" id="Captcha" name="Captcha" autocomplete="off" placeholder="<lang>Repeat the CAPTCHA Code</lang>"';
    devCodeCAPTCHA();
    echo '></div></div></div>' . nl;
}
    ...
    if ($User->hasRole('staff') || $User->hasRole('admin')) {
        echo '<div class="container mt-3"><div class="row py-1"><div class="col-12 col-md-6"><a href="/order-view/' . $item['OrderID'] . '/finalize" class="btn btn-success btn-block float-left"><lang>Finalize Order</lang></a></div></div></div>' . nl;

        echo '<form action="/order-view/' . $item['OrderID'] . '/split" method="post">';
        echo '<div class="container mt-3"><div class="row py-1"><div class="col-12 col-md-6"><span class="float-left pt-2"><lang>Vendor</lang></span><input type="text" class="form-control float-left ml-2" style="width: 10%;" name="Vendor"><span class="float-left pt-2 ml-2">%</span><span class="float-left pt-2 ml-5"><lang>Buyer</lang></span><input type="text" class="form-control float-left ml-2" style="width: 10%;" name="Buyer"><span class="float-left pt-2 ml-2">%</span></div></div></div>';
        echo '<div class="container"><div class="row py-1"><div class="col-12 col-md-6"><button type="submit" class="btn btn-warning btn-block float-left"><lang>Split Amount</lang></a></div></div></div>';
        echo '</form>' . nl;

        echo '<div class="container mt-3"><div class="row py-1"><div class="col-12 col-md-6"><a href="/order-view/' . $item['OrderID'] . '/cancel" class="btn btn-danger btn-block float-left"><lang>Cancel Order</lang></a></div></div></div>' . nl;
    }
}
...
if (!is_null($item['BuyerReview']) && !$DoReview) {
    ...
    <div class="row py-1">
        <div class="col-md-12 font-weight-light text-muted mb-2">
            <h5><lang>Buyer&rsquo;s Review</lang>:</h5>
        </div>
...
if (!is_null($item['VendorReview']) && !$DoReview) {
    ...
    <div class="row py-1">
        <div class="col-md-12 font-weight-light text-muted mb-2">
            <h5><lang>Vendor&rsquo;s Review</lang>:</h5>
        </div>
        <div class="col-md-12 overflow-auto">
