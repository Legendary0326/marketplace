...
if (!$Account->found()) {
    echo Alerts::danger('<lang>User Not Found!</lang>', 'mt-3');
    return;
}
...
<div class="container mt-3">
    <div class="row py-1">
        <div class="col-md-12 text-info">
            <h3><lang>Change Account Parameters</lang>:</h3>
        </div>
    </div>
</div>
    ...
    <div class="container mt-2">
        <div class="row py-1">
            <div class="col-md-12 font-weight-light text-muted mb-2">
                <lang>Current Commission Fee</lang>:
            </div>
        ...
        <div class="row py-1">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <span class="ml-4 text-danger"><lang>Block transactions</lang></span>
                    ...
                    <span class="ml-4 text-danger"><lang>Block login</lang></span>
                </div>
            </div>
        </div>
    </div>
