            ...
            if (XMR::checkAddress($_POST['Address'])) {
                ...
                if ($UserAmount > 0) {
                    ...
                    if ($USD >= XMR_MINUSD) {
                        ...
                        echo Alerts::danger(sprintf('<lang>The Balance On Your Account Is Too Low! (Min. Balance = %.2f US-$!)</lang>', XMR_MINUSD), 'mt-3');
                    }
                } else {
...
<div class="container mt-3">
    <div class="row py-1">
        <div class="col-md-12 text-info">
            <h3><lang>Your Personal Monero Wallet</lang>...</h3>
        </div>
    </div>
</div>
...
<div class="container mt-3">
    <div class="row py-1">
        <div class="col-md-12">
            ...
            <br><br>
            <span class="text-danger"><lang>If you send Monero coins to an unvalid address, they might not be credited to your wallet!</lang></span>
        </div>
    </div>
</div>
...
<div class="container mt-3">
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-primary btn-block mx-auto d-block" style="width: 33%; min-width: 250px;" href="/monerowallet/create"><lang>Create Deposit Address</lang></a>
        </div>
    </div>
</div>
    ...
    <div class="row py-1">
        ...
        <div class="table-responsive-md" style="min-width: 100%;">
            <table class="table table-bordered-wallet-in">
                <tr>
                    <th scope="col" class="text-nowrap" style="width: 25%;"><lang>ID</lang></th>
                    <th scope="col" class="text-nowrap" style="width: 25%;"><lang>Date</lang></th>
                    <th scope="col" class="text-nowrap" style="width: 25%;"><lang>Amount</lang></th>
                    <th scope="col" class="text-nowrap" style="width: 25%;"><lang>Status</lang></th>
                </tr>
<?php
...
if (count($Transactions) >= 1) {
    foreach ($Transactions as $Transaction) {
        ...
        echo '<td class="text-nowrap">' . ($Transaction['Confirmations'] >= 10 ? '<lang>Confirmed</lang>' : '<lang>Pending</lang>') . '</td>' . nl;
        echo '</tr>' . nl;
    }
}
?>
