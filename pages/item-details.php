...
if (isset($Paths['1'])) {
    if ($Paths['1'] == 'orderplaced') {
        echo Alerts::success('<lang>Order Is Placed.</lang>', 'mt-3');
...
<div class="container mt-0">
    <div class="row py-1">
        <div class="col-md-12">
            <span class="text-muted"><lang>Category</lang>:</span>&nbsp;&nbsp;
<?php
...
<div class="container mt-0">
    <div class="row py-1">	
        <div class="col-12 col-md-6">
            <span class="text-muted"><lang>Payment Processing</lang>:</span>&nbsp;&nbsp;
...
<div class="container mt-0">
    <div class="row py-1">
        ...
        <div class="col-md-4">
            <span class="text-muted"><lang>Scoring</lang>:</span>&nbsp;&nbsp;
...
<div class="container mt-0 mt-3">
    <div class="row py-1">
        <div class="col-8 col-md-3">
            <span class="text-muted"><lang>Item Description</lang>:</span>
        </div>
...
<div class="container mt-0">
    <div class="row py-1">
        <div class="col-6 col-md-3">
            <span class="text-muted text-nowrap"><lang>Item Online Since</lang>:</span>
        </div>
...
<?php echo $Language->date($item['Created']); ?>
    ...
    <div class="row py-1">
        <div class="col-6 col-md-3">
            <span class="text-muted text-nowrap"><lang>Total Views</lang>:</span>
        </div>
        <div class="col-auto">
<?php echo $item['Views']; ?>
        </div>
    ...
    <div class="row py-1">
        <div class="col-6 col-md-3">
            <span class="text-muted text-nowrap"><lang>Total Sales</lang>:</span>
        </div>
        <div class="col-auto">
<?php echo $item['Sales']; ?>
        </div>
    ...
    <div class="row py-1">
        <div class="col-6 col-md-3">
            <span class="text-muted text-nowrap"><lang>Quantity Left</lang>:</span>
        </div>
        <div class="col-auto">
...
<div class="container mt-4">
    <div class="row py-1">
        ...
        <div class="col-md-12 font-weight-light text-muted mb-3">
            <span class="small">(<lang>You find the detailed reviews at the bottom of this page!</lang>)</span>
        </div>
...
<div class="container mt-4">
    <div class="row py-1">
        <div class="col-sm-4 col-md-3 col-lg-2">
            <span class="text-muted"><lang>Singel Price</lang>:</span>
        </div>
    ...
    <div class="container mt-0">
        <div class="row py-1">
            <div class="col-md-2 pb-2">
                <span class="text-muted"><lang>Quantity</lang>:</span>
            </div>
...
?>
    ...
    <div class="container mt-0">
        <div class="row py-1">
            <div class="col-md-2 pb-2">
                <span class="text-muted"><lang>Shipping Method</lang>:</span>
            </div>
            <div class="col-12 col-md-6">
                <div class="form-group">
        ...
        <div class="row py-1">
            <div class="col-12 col-md-3">
                <div class="input-group-append">
                    <button class="btn-sm btn-secondary" type="submit"><lang>Calculate Total Price</lang></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="mb-2">
                ...
                <form action="/payment-overview/<?php echo $item['ItemID']; ?>" method="post">
                    ...
                    <button class="btn-xmr btn-xmr-primary btn-xmr-block p-1 mt-2" type="submit"><img class="" src="/img/xmr_white.png" alt="Logo" title="" width="20px" height="20px"/>&nbsp;<lang>Order Now</lang></button>
                </form>
            </div>
        </div>
<?php
        ...
        <div class="col-md-3">
            <div class="mb-2">
                ...
                <form action="/payment-overview/<?php echo $item['ItemID']; ?>" method="post">
                    ...
                    <button type="submit" class="btn-btc btn-btc-primary btn-btc-block p-1 mt-2" href="#"><img class="" src="/img/btc_white.png" alt="Logo" title="" width="20px" height="20px"/>&nbsp;<lang>Order Now</lang></button>
                </form>
            </div>
        </div>
<?php
        ...
        <div class="col-md-3">
            <div class="mb-2">
                ...
                <form action="/payment-overview/<?php echo $item['ItemID']; ?>" method="post">
                    ...
                    <button type="submit" class="btn-ltc btn-ltc-primary btn-ltc-block p-1 mt-2" href="#"><img class="" src="/img/ltc_white.png" alt="Logo" title="" width="20px" height="20px"/>&nbsp;<lang>Order Now</lang></button>
                </form>
            </div>
        </div>
<?php } ?>
...
<div class="container mt-4">
    <div class="row py-1">
        <div class="col-md-12 text-muted mb-2">
            <lang>Vendor&rsquo;s Terms and Conditions</lang>:
        </div>
        <div class="col-md-12">
            <div class="form-group">
...
<div class="container mt-2">
    <div class="row py-1">
        <div class="col-md-12 text-muted mb-2">
            <lang>Vendor&rsquo;s Refund Policy</lang>:
        </div>
        <div class="col-md-12">
            <div class="form-group">
            ...
            <table class="table-sm table-bordered-positive overflow-auto">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center text-nowrap w-25"><lang>Item</lang></th>
                        <th scope="col" class="text-center text-nowrap"><lang>Rating</lang></th>
                        <th scope="col" class="text-center text-nowrap"><lang>Buyer</lang></th>
                        <th scope="col" class="text-left text-nowrap pl-4 w-75"><lang>Feedback</lang></th>
                    </tr>
                </thead>
                <tbody>
<?php
