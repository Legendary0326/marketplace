<?php /***REALFILE: /var/www/vhosts/market1304.de/httpdocs/nav/top_guest.php***/
$ls = $Language->getLanguages();
?><div class="container-fluid">
<div class="d-flex justify-content-end" style="border-top: 5px solid #378BE5;">
    <div><a style="color: #378BE5;" href="/login" class="btn btn-link top-guest">Anmeldung</a></div>
    <div><a style="color: #378BE5;" href="/register" class="btn btn-link top-guest">Registrierung</a></div>
