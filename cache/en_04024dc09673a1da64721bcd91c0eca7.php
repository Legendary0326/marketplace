<?php /***REALFILE: /var/www/vhosts/market1304.de/httpdocs/pages/vendororders.php***/
...
<?php if ($ShowArchived) { ?>
            <a class="text-white" href="/vendororders" class="btn btn-link">Current Orders</a>
<?php } else { ?>
            <a class="text-white" href="/vendororders/archived" class="btn btn-link">Archived Orders</a>
<?php } ?>
        </div>
    </div>
</div>
