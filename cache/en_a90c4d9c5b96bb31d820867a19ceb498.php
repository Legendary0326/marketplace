<?php /***REALFILE: /var/www/vhosts/market1304.de/httpdocs/pages/account-user.php***/
...
<div class="container mt-4">
    <div class="row py-1" id="subMenu">
        <div class="col-md-12 px-2 text-nowrap">
            <a class="text-white" href="/invite-user" class="btn btn-link">Invite As a Vendor</a>
        </div>
    </div>
</div>
...
<div class="container mt-3">
    <div class="row py-1">
        <div class="col-6 col-md-8 text-info mb-2">
            <span><h3>Overview Of All User Accounts...</h3></span>
        </div>
    </div>
</div>
    ...
    <div class="row py-1">
        <div class="col-md-12 overflow-auto">
            <table class="table-sm table-bordered-standard w-100">
                <tr>
                    <th scope="col" class="text-center text-nowrap">Username</th>
                    <th scope="col" class="text-center text-nowrap">First Login</th>
                    <th scope="col" class="text-center text-nowrap">Last Login</th>
                    <th scope="col" class="text-center text-nowrap">Status</th>
                    <th scope="col" class="text-center text-nowrap">Scoring</th>
                    <th scope="col" class="text-center text-nowrap">Cash Flow (US-$)</th>
...
<td class="text-right">' . $Language->number($UserList['CashFlow'], 2) . '</td>' . nl;
    ...
    echo '<td class="text-center"><a class="btn-sm btn-primary" href="/account-support/' . $UserList['UserID'] . '" role="button">Edit</a></td>
</tr>' . nl;
}
?>
            </table>
