<?php /***REALFILE: /var/www/vhosts/market1304.de/httpdocs/pages/account-vendor.php***/
...
<div class="container mt-3">
    <div class="row py-1">
        <div class="col-6 col-md-8 text-info mb-2">
            <span><h3>Overview Of All Vendor Accounts...</h3></span>
        </div>
    </div>
</div>
        ...
        <div class="col-md-12 overflow-auto">
            <table class="table-sm table-bordered-standard w-100">
                <tr>
                    ...
                    <th scope="col" class="text-center text-nowrap">Fee</th>
...
<td class="text-center"><a class="btn-sm btn-primary" href="/account-support/' . $UserList['UserID'] . '" role="button">Edit</a></td>
</tr>' . nl;
}
?>
            </table>
