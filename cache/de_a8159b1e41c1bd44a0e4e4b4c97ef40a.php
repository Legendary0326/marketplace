<?php /***REALFILE: /var/www/vhosts/market1304.de/httpdocs/pages/index.php***/
...
<div class="container mt-0">
    <div class="row py-1">
        <div class="col-7 col-md-3">
            <span class="font-weight-light text-muted">offene Streitfälle:</span>
        </div>
...
<div class="container mt-4">
    <div class="row py-1">
        <div class="col-md-12 font-weight-light text-muted mb-2">
            <h5>Marktplatz Gewinn:</h5>
        </div>
        <div class="col-md-12 overflow-auto">
            <table class="table-sm table-bordered-standard w-100">
                <tr>
                    <th scope="col" class="text-left">Zeitraum</th>
        ...
        <div class="col-md-12 overflow-auto">
            <table class="table-sm table-bordered-standard w-100">
                <tr>
                    ...
                    <th scope="col" class="text-center">Treuhandzahlung</th>
...
<div class="container mt-4">
    <div class="row py-1">
        <div class="col-md-12 font-weight-light text-muted mb-2">
            <h5>Verkäufer meiste Artikel online:</h5>
        </div>
        <div class="col-md-12 overflow-auto">
            <table class="table-sm table-bordered-standard w-100">
                <tr>
                    <th scope="col" class="text-left">Nutzer</th>
                    <th scope="col" class="text-left">Anzahl Artikel</th>
                    <th scope="col" class="text-left">Verkäufer Status</th>
                    <th scope="col" class="text-left">Verkäufer Wertung</th>
                </tr>
<?php
...
<div class="container mt-4">
    <div class="row py-1">
        ...
        <div class="col-md-12 overflow-auto">
            <table class="table-sm table-bordered-standard w-100">
                <tr>
                    <th scope="col" class="text-left">Verkäufer</th>
                    <th scope="col" class="text-left">aktuelle Gebühr (%)</th>
...
<div class="container mt-4">
    <div class="row justify-content-md-center">
        ...
        <div class="col-md-10 text-center mt-4">
            Wenn der oben abgebildete Text nicht mit Ihrer APP übereinstimmt, befinden Sie sich mutmaßlich auf einer Betrugs- oder Phishing-Seite!
        </div>
        <div class="col-md-10 text-center mt-2 pb-4" id="hyphen">
            In diesem Fall melden Sie sich bitte über eine verifizierte Marktplatz-URL an und ändern Sie unverzüglich Ihr Passwort und Ihren Auszahlungscode (WDC)!
        </div>
