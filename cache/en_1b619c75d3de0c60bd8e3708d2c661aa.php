<?php /***REALFILE: /var/www/vhosts/market1304.de/httpdocs/pages/account.php***/
...
?>
<h1 class="text-info mt-4">2FA-Verification</h1>
...
<form action="/account/enable2fa" method="post">
    ...
    <div class="form-group">
        <div class="mt-3 mb-3" style="line-height: 1;">
            <span class="font-weight-light text-info">After you enable the 2FA verification please check if your PGP public key is correct by decrypting the displayed 2FA code. After a correct confirmation, you will be logged out for security reasons. Please log in again using 2FA!</span>
        </div>
    </div>
    <br>
    <div class="form-group">
...
<?php if ($User->hasRole('user')) { ?>
        <div class="col-md-6 px-2 text-nowrap" id="borderPageHeader">
            <a class="text-white" href="/changepassword" class="btn btn-link">Change Passwords</a>
        </div>
...
if ($Pages->inPath('errorPGP')) echo Alerts::danger('Sorry, There Was an Error! the Time Limit Has Been Exceeded, You Entered an Incorrect Code and/or Your Pgp-Key Is Invalid or 2fa Is Maybe Not Enable!', 'mt-3');
if ($Pages->inPath('2famandatory')) echo Alerts::danger('2FA Is Mandatory for Your Account!', 'mt-3');
?>
...
<div class="container mt-3">
    <div class="row py-1">
        <div class="col-md-12">
            Please complete your profile below. Providing the following information is voluntary.
            <br>
            Required fields for vendors are marked in&nbsp;<span class="text-danger">Red</span>!
            <br>
            For security reasons, we recommend you to change your password and your withdrawal code (WDC) regularly!
            <br>
            In addition to this, it is also advisable to change your APP regularly and to make sure that your APP is displayed whenever you log into your account.
        </div>
    </div>
</div>
<?php } ?>
