<?php /***REALFILE: /var/www/vhosts/market1304.de/httpdocs/pages/message-in.php***/
            ...
            <div class="col-md-6 overflow-auto">
                <table class="table-sm table-bordered-standard w-100">
                    <tr style="border: 1px solid transparent;">
                        <th class="text-left text-nowrap" style="background: transparent; border-left: 2px solid #378BE5;"><a href="/message-new"><img src="/img/mail_new_blue.png" width="15"><span class="pl-2" style="color: #378BE5;">Create New Message</span></a></th>
                        <th class="text-left text-nowrap" style="background: transparent; border-left: 2px solid #378BE5;"><button type="submit" style="background: transparent; border: transparent;"><img src="/img/delete_blue.png" width="15"><span class="pl-2" style="color: #378BE5;">Delete Message</span></button></th>
                    </tr>
                </table>
            </div>
            <div class="col-md-12 overflow-auto">
                <table class="table-sm table-bordered-standard w-100">
                    <tr>
                        ...
                        <th class="text-center text-nowrap" style="min-width: 200px;">Message From</th>
                        <th class="text-center" style="min-width: 400px;">Subject</th>
