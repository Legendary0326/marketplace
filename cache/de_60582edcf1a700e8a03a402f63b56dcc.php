...
#menuShowHideAdmin + label:before {content:"Admin Menü einblenden";}
#menuShowHideAdmin:checked + label:before {content:"Admin Menü ausblenden";}
#menuShowHide + label:before {content:"Menü einblenden";}
#menuShowHide:checked + label:before {content:"Menü ausblenden";}
}
</style>
...
?>
    ...
    <div class="row py-1 border-bottom border-white" id="exchange">
        <div class="col-md-auto text-white border-right border-white text-nowrap">
            <span class="font-weight-light">Wechselkurse</span>
        </div>
        <div class="col-md-auto text-white border-right border-white text-nowrap">
    ...
    <div class="row py-1 border-bottom border-white" id="balance">
        <div class="col-md-auto text-white text-nowrap" id="borderHead">
            <span class="font-weight-light">Guthaben Wallets</span>
        </div>
<?php
...
<?php } ?>
    ...
    <div class="row py-1" id="mainMenu">
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/marketplace" class="btn btn-link">Marktplatz</a>
        </div>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white text-decoration-white" href="/account" class="btn btn-link">Konto</a>
        </div>
<?php if ($User->hasRole('vendor')) { ?>
        <div class="col-xs-auto px-2" id="borderHead" style="display: ">
            <a class="text-white" href="/vendorshop" class="btn btn-link">Verkäufer-Shop</a>
        </div>
<?php } ?>
        <div class="col-xs-auto px-2" id="borderHead">
...
if ($User->hasRole('user') || $User->hasRole('vendor')) { ?>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/userorders" class="btn btn-link">Bestellungen</a>
        </div>
<?php }?>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/message-in" class="btn btn-link">Nachrichten<?php if ($CountUnreadMessages >= 1) { echo '<span class="badge badge-light badge-pill ml-1">' . $CountUnreadMessages . '</span>'; } ?></a>
        </div>
<?php if ($User->hasRole('user') || $User->hasRole('vendor')) { ?>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/help" class="btn btn-link">Hilfe</a>
        </div>
<?php }?>
        <div class="col-xs-auto px-2">
            <a class="text-white" href="/logout" class="btn btn-link">Abmelden</a>
        </div>
    </div>
    ...
    <div class="row" style="cursor: auto;">
        <div style="width: 55%; max-width: 250px; float: left; margin-left: -60px; margin-top: 15px;">
            ...
            <div style="width: 60%; color: white; line-height: 1.5;">
                <div class="font-weight-light text-nowrap mt-2">Angemeldet als:</div>&nbsp;
                <div>
<?php
...
<?php echo Ranking::getVendorRank($User->get('VendorRank')); ?>
            ...
            <br>
<?php } ?>
            <div class="mt-2">Wertung:</div>
            <div class="font-weight-light text-nowrap">
<?php
echo $Language->number($User->get('Scoring'), 2);
?>%</div>
            <br>
            <div class="mt-2 text-nowrap">erste Anmeldung:</div>
            <div class="font-weight-light text-nowrap">
<?php
...
?>
            ...
            <br>
            <div class="mt-2 text-nowrap">letzte Anmeldung:</div>
            <div class="font-weight-light text-nowrap">
<?php
...
?>
            ...
            <br>
            <div class="mt-2">Verkäufe:<span class="font-weight-light">
<?php
echo $User->get('Sales');
?>
            </span></div>
            <br>
            <div class="mt-2">Käufe:<span class="font-weight-light">
<?php
...
<?php
    ...
    <div class="row mb-4" id="mainMenuAdmin">
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/item-overview" class="btn btn-link">Artikel</a>
        </div>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/order-overview" class="btn btn-link">Bestellungen</a>
        </div>
<?php if ($User->hasRole('admin')) { ?>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/categories" class="btn btn-link">Kategorien</a>
        </div>
<?php } ?>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/messages-support" class="btn btn-link">Nachrichten<?php
...
?></a>
        ...
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/account-user" class="btn btn-link">Nutzer</a>
        </div>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/account-vendor" class="btn btn-link">Verkäufer</a>
        </div>
<?php if ($User->hasRole('admin')) { ?>
        <div class="col-xs-auto px-2" id="borderHead">
            <a class="text-white" href="/account-staff" class="btn btn-link">Staff</a>
        </div>
<?php } ?>
        <div class="col-xs-auto px-2">
            <a class="text-white" href="/dispute-admin" class="btn btn-link">Streitfälle<?php
