...
?><style>
#catShowHide_down + label::before { content: "<lang>All Categories</lang>"; }
#catShowHide_down:checked + label::before { content: "<lang>All Categories</lang>"; }
#searchShowHide_down + label::before { content: "<lang>Search Options</lang> ▼"; }
#searchShowHide_down:checked + label::before { content: "<lang>Search Options</lang> ▲"; }
</style>
...
echo '<div><a style="color: #495057; margin-left: -1.8%;" href="/marketplace?setCat=ALL"><span><lang>All Categories</lang></span><span style="margin-left: 25px; color: #007bff;">(' . Categories::numAllCategories() . ')</span></a></div><br>' . nl;
...
?>
            ...
            <div class="col-md-6 p-1">
                <div class="input-group" style="margin-bottom: -20px;">
                    <input type="text" class="form-control" placeholder="<lang>Searchterm</lang>" name="searchterm" value="<?php echo $Market->get('searchterm'); ?>">
                    <div class="input-group-append">
                        <button class="btn-sm btn-secondary ml-2" type="submit"><lang>Search</lang></button>
                    </div>
                </div>
                <br>
                ...
                <aside id="search_down" style="margin-top: -20px; line-height: 80%;">
                    <div class="row" style="cursor: auto;">
                        <br>
                        <br>
                        <div><lang>Category</lang>:</div>
                        <br>
                        <div class="col-md-6 p-1 pr-3">
                            <select class="form-control" name="category">
                            <option value=""><lang>All Categories</lang></option>
<?php
foreach ($Categories as $CategoryID => $Category) {
...
?>
                        ...
                        <br>
                        <div><lang>Price Range</lang>:</div>
                        <br>
                        <br>
                        <div class="form-group">
                            <span class="float-left pt-2"><lang>From</lang>&nbsp;</span><input type="text" class="form-control w-25 float-left" placeholder="0.00" name="priceFrom" value="<?php echo (empty($Market->get('priceFrom')) ? '' : $Language->number($Market->get('priceFrom'), 2)); ?>"><span class="float-left pt-2">&nbsp;<lang>Till</lang>&nbsp; </span><input type="text" class="form-control w-25 float-left" placeholder="9999.99" name="priceTill" value="<?php echo (empty($Market->get('priceTill')) ? '' : $Language->number($Market->get('priceTill'), 2)); ?>"><span class="float-left pt-2">&nbsp;<?php echo $User->get('Currency'); ?></span>
                        </div>
                        <br>
                        <br>
                        <br>
                        <br>
                        <lang>Minimum Vendor Status</lang>:
                        <br>
                        <br>
                        <div>
...
?>
                        ...
                        <br>
                        <lang>Country of Dispatch</lang>:
                        <br>
                        <br>
                        <div>
                        <select class="form-control" name="shipFrom">
                            <option value=""><lang>All Countries</lang></option>
<?php
...
?>
                        ...
                        <div>
                            <select class="form-control" name="orderBy">
                                <option value="priceASC"<?php echo Forms::selectedVal($Market->get('orderBy'), 'priceASC'); ?>><lang>Price Asc</lang></option>
                                <option value="priceDESC"<?php echo Forms::selectedVal($Market->get('orderBy'), 'priceDESC'); ?>><lang>Price Desc</lang></option>
                                <option value="dateASC"<?php echo Forms::selectedVal($Market->get('orderBy'), 'dateASC'); ?>><lang>Date Asc</lang></option>
                                <option value="dateDESC"<?php echo Forms::selectedVal($Market->get('orderBy'), 'dateDESC'); ?>><lang>Date Desc</lang></option>
                            </select>
                        </div>
                    </div>
                </aside>
